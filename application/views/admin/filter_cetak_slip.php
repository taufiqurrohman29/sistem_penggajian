        ...
        <div class="card shadow-sm border-bottom-success">
            <div class="card-header bg-white py-3">
                <h4 class="h5 align-middle m-0 font-weight-bold text-success">
                    Filter Cetak Slip Gaji Pegawai
                </h4>
            </div>

            <form method="post" action="<?php echo base_url('admin/slip_gaji/cetak_slip')?>">
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-lg-3 text-lg-right">Nama Pegawai</label>
                    <div class="col-lg-5">
                        <div class="input-group">
                            <select class="form-control mr-2" name="nama_pegawai">
                ...
                <div class="row form-group">
                    <div class="col-lg-9 offset-lg-3">
                        <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-print"></i> Cetak Slip Gaji</button>
                    </div>
                </div>
                </form>
            </div>
