        ...
        <div class="card shadow-sm border-bottom-success">
            <div class="card-header bg-white py-3">
                <h4 class="h5 align-middle m-0 font-weight-bold text-success">
                    Form Laporan Gaji Pegawai
                </h4>
            </div>

            <form method="post" action="<?php echo base_url('admin/laporan_gaji/cetak_gaji')?>">
            <div class="card-body">
                ...
                <div class="row form-group">
                    <div class="col-lg-9 offset-lg-3">
                        <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-print"></i> Cetak Laporan Gaji</button>
                    </div>
                </div>
                </form>
            </div>
